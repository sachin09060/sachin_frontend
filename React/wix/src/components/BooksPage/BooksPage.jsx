      ...
      <Container className="col-12 mt-5">
        <Row className="bg-dark bg-opacity-10">
          <Col md={6} className="my-auto">
            <h1 className="text-initial d-flex me-5 justify-content-center">
              BREAKFASTS
            </h1>
            ...
            <h1 className="col-6" style={{marginLeft:"60px"}}>
              40<sup>$</sup>{" "}
        ...
        <Row className="bg-dark bg-opacity-10 mt-3">
          <Col md={6} className="my-auto">
            <h1 className="text-initial d-flex me-5 justify-content-initial" style={{marginLeft: '70px'}}>
              SUGAR & <br />
              SPICE
            </h1>
        ...
        <Row className="bg-dark bg-opacity-10 mt-3">
          <Col md={6} className="my-auto">
            <h1 className="text-initial text-intial d-flex me-5 justify-content-initial" style={{marginLeft: '70px'}}>
              HOLIDAY <br />
              SEASON <br /> SPECIALS
            </h1>
            <p className=" col-8 mt-3">
