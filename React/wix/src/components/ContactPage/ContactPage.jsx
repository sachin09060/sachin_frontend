    ...
    <>
      ...
      <Container className="text-center d-flex" id="main-container">
        <Row>
          ...
          <Col sm={12} md={6} lg={6} className="p-5 text-initial text-initial" style={{paddingLeft: "0px" , margiLeft: "0px", Left: "0px"}}>
            <h2>GET IN TOUCH</h2>
            ...
            <Container className=" mt-5 col-9">
              ...
              <p className="mt-5 ml-0">Stay Up-To-Date with New Posts</p>
            </Container>
